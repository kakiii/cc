...
const Game = () => {
  ...
  const renderScene = () => {
    switch (scene) {
      case 0:
        return (
          <>
            <p>Scene: Kendall and Jan are sitting in a cozy café, enjoying a cup of coffee together.</p>
      ...
      case 4:
        return (
          <>
            ...
            <p>Consequence:</p>
            <p>(Scene: Kendall and Jan settle into their new home, surrounded by love, warmth, and the fruits of their shared navigation. The space becomes a sanctuary where their love flourishes, creating lasting memories and a solid foundation for their future together. Kendall feels a deep sense of fulfillment, knowing they were able to provide a great place for their shared happiness to thrive.)</p>
          </>
        );
      case 5:
        return (
          <>
            ...
            <p>Consequence:</p>
            <p>(Scene: Kendall and Jan's relationship continues to flourish, filled with love, understanding, and mutual respect. They create a harmonious life together, supporting each other's dreams and aspirations. As time passes, their commitment deepens, and they decide to take their relationship to the next level.)</p>
      ...
      case 10:
        return (
          <>
            <p>Ending 5:</p>
            <p>(Scene: Kendall and Jan's appreciation for each other deepens their connection.)</p>
            ...
            <p>Consequence:</p>
            <p>(Scene: Jan's appreciation for Kendall's kindness deepens their bond, and they continue to nurture their relationship with care and understanding. The experience strengthens their bond, allowing them to overcome Jan's past reservations and build a loving and trusting partnership.)</p>
          </>
        );
      default:
        return null;
  ...
  const renderEndingPage = () => {
    return (
      <div>
        <h1>Thank You!</h1>
        <p>Thank you for playing the game. Please save your game history for future reference.</p>
